...
outputfname_1 = "revised_results_unique_smiles.txt"
...
for smiles_dict in all_smiles_dicts:
    ...
    curr_dict_name = curr_dict_name[curr_dict_name.index("revised_"):]

    all_smiles_dicts_json_dump[curr_dict_name] = smiles_dict

outputfname_2 = "revised_results.json"
