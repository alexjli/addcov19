...
y1 = -np.load('../../data/zinc/targets.npy')
y2 = -np.load('../../data/zinc/logKas_tryp_trimmed.npy')
y = y1-y2
y = y.reshape((-1, 1))
...
SA_scores = np.load('../../data/zinc/SA_scores.npy')
cycle_scores = np.load('../../data/zinc/cycle_scores.npy')
